...
# </html>
# """
#     def update_state(self, action, attrs):
#         if action == "insert":
#             self.state[attrs["id"]] = attrs
#         elif action == "modify":
#             self.state[attrs["targetId"]].update(attrs["attrs"])
#         elif action == "remove":
#             del self.state[attrs["targetId"]]
#         elif action == "clear":
#             self.state = {}

#     def render_state(self, html, output_path="/m2/slz/Html/hd_output2.png"):
